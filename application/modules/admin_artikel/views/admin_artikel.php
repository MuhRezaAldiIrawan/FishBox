...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo base_url()?>assets_admin/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="<?php echo base_url()?>assets_admin/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <link rel="stylesheet" href="<?php echo base_url()?>assets_admin/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?= base_url('admin_home'); ?>" class="nav-link">Home</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url('admin_home'); ?>" class="brand-link">
      <img src="<?php echo base_url()?>assets_admin/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url()?>assets_admin/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
			  ...
			  <a href="<?= base_url('tambah_artikel'); ?>" class="btn btn-primary">Tambah Artikel</a><br><br>
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
					...
					<td><?= $art->dilihat ?></td>
					<td>
						<a onclick='return confirm("Yakin ingin menghapus artikel tersebut?")' class="btn btn-danger" href="<?= base_url('admin_artikel/hapus_artikel/'.$art->id) ?>">Hapus</a>
...
<script src="<?php echo base_url()?>assets_admin/plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
<script src="<?php echo base_url()?>assets_admin/plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
