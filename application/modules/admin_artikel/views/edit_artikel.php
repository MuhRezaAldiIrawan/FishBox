              ...
              <!--<form method="post" action="<?= base_url('admin_artikel/update'); ?>" enctype="multipart/form-data">-->
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input name="judul" type="text" class="form-control" id="exampleInputEmail1" placeholder="Judul Artikel" value="<?= $artikel->judul ?>">
                  </div>
                  <div class="form-group">
                    <label>Slug</label>
                    <input name="slug" type="text" class="form-control"  placeholder="Slug Artikel" value="<?= $artikel->slug ?>">
                  </div>
                  <div class="row mb-3">
					<div class="col-md-3">
